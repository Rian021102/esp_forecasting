...
if uploaded_file is not None:
    ...
    #replace all the values in the Well column with Well and number like, Well-1 sequentially
    data['Well'] = data['Well'].str.replace(r'\D+', 'Well-')
    st.write(data.head())
    ...
    for col in numeric_cols:
        ...
        #perform isolation forest with contamination set to auto
