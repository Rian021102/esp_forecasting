...
def main():
    ...
    model = tf.keras.models.load_model('/Users/rianrachmanto/miniforge3/project/esp_forecast_LSTM/model/autoencoder_temp.h5')
    ...
    test_score_df['TM'] = scaler.inverse_transform(test_score_df[column_name].values.reshape(-1, 1))
    ...
    if yhat.shape[0] == len(test_score_df):
        test_score_df['Predicted_Temp'] = predicted_inv[-len(test_score_df):]
    else:
